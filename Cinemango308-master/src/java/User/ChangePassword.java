    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("password") != null) {
                int oldpw = request.getParameter("oldpw").hashCode();
                ...
                if (manager.updatePassword(userid, oldpw, password)) {
                    passwordValid = true;
            ...
            if (!passwordValid) {
                ErrorMessageBean ErrorMsg = new ErrorMessageBean("Invalid Password");
